        ...
        <form action="<?php echo constant('URL'); ?>input/ingresarItem" method="post">
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="ncliente" id="ncliente" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group">
              <label for="nitcliente">NIT</label>
              <input type="text" name="nitcliente" id="nitcliente" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group">
              <label for="correocliente">Correo</label>
              <input type="text" name="correocliente" id="correocliente" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group row">
              <div class="form-group col">
                <label for="contactocliente">Contacto</label>
                <input type="text" name="contactocliente" id="contactocliente" class="form-control" placeholder="" aria-describedby="helpId">
              </div>
              <div class="form-group">
                <label for="telcliente">Teléfono</label>
                <input type="text" name="telcliente" id="telcliente" class="form-control" placeholder="" aria-describedby="helpId">
              </div>
            </div>  
          </div>
          <div class="form-group">
